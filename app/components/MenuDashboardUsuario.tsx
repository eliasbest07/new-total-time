                ...
                <div className="p-4 sm:p-6 border-b border-white/20 bg-gradient-to-r from-white/5 to-white/10">
                    <div className="flex justify-between items-center">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h2 className="text-white text-lg sm:text-xl font-semibold">{userName}</h2>
                                <p className="text-white/60 text-xs sm:text-sm">{userOrganization}</p>
                            </div>
                        </div>
                        <button
                            onClick={onClose}
...
export default MenuDashboardUsuario;
