...
export default function MisionesOrganizacion() {
  ...
  console.log('🎯 [MisionesOrganizacion] usuarioId:', usuarioId);
  ...
  if (!usuarioId) {
    console.log('🎯 [MisionesOrganizacion] No hay usuarioId, no renderizando');
    return null;
  }
