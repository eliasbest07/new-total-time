...
export default function Dashboard() {
  ...
  const [selectedMision] = useState<{ title: string, hours: number } | null>(null);
  ...
  const mockUsuarios: Usuario[] = [
    new Usuario('1', 'juan.perez@example.com', Rol.ADMIN, { nombre: 'Juan Pérez', apellido: '', avatar: '', nivel: 5, correo: 'juan.perez@example.com', username: 'jperez', bio: '', idea: '', marco: '' }, 95, 'auth1', true, 'org1', [Permiso.CREAR_SALA, Permiso.PUBLICAR_EN_SALA], new Date(Date.now() - 2 * 60000)),
    new Usuario('2', 'maria.rodriguez@example.com', Rol.MIEMBRO, { nombre: 'María Rodríguez', apellido: '', avatar: '', nivel: 3, correo: 'maria.rodriguez@example.com', username: 'mrodriguez', bio: '', idea: '', marco: '' }, 88, 'auth2', false, 'org1', [Permiso.VER_CAPTURAS_USUARIO], new Date(Date.now() - 15 * 60000)),
    new Usuario('3', 'carlos.gomez@example.com', Rol.MIEMBRO, { nombre: 'Carlos Gómez', apellido: '', avatar: '', nivel: 4, correo: 'carlos.gomez@example.com', username: 'cgomez', bio: '', idea: '', marco: '' }, 92, 'auth3', false, 'org1', [Permiso.PUBLICAR_EN_SALA, Permiso.TOMAR_DE_PIZARRA], new Date(Date.now() - 45 * 60000)),
    new Usuario('4', 'ana.martinez@example.com', Rol.MIEMBRO, { nombre: 'Ana Martínez', apellido: '', avatar: '', nivel: 2, correo: 'ana.martinez@example.com', username: 'amartinez', bio: '', idea: '', marco: '' }, 76, 'auth4', false, 'org1', [Permiso.VER_CAPTURAS_USUARIO], new Date(Date.now() - 3 * 60 * 60000)),
    new Usuario('5', 'luis.fernandez@example.com', Rol.ADMIN, { nombre: 'Luis Fernández', apellido: '', avatar: '', nivel: 6, correo: 'luis.fernandez@example.com', username: 'lfernandez', bio: '', idea: '', marco: '' }, 98, 'auth5', true, 'org1', [Permiso.CREAR_SALA, Permiso.ELIMINAR_USUARIO, Permiso.ELIMINAR_PROYECTO], new Date(Date.now() - 1 * 60000)),
    new Usuario('6', 'sofia.lopez@example.com', Rol.MIEMBRO, { nombre: 'Sofía López', apellido: '', avatar: '', nivel: 3, correo: 'sofia.lopez@example.com', username: 'slopez', bio: '', idea: '', marco: '' }, 84, 'auth6', false, 'org1', [Permiso.VER_CAPTURAS_USUARIO], new Date(Date.now() - 8 * 60 * 60000)),
    new Usuario('7', 'diego.sanchez@example.com', Rol.MIEMBRO, { nombre: 'Diego Sánchez', apellido: '', avatar: '', nivel: 4, correo: 'diego.sanchez@example.com', username: 'dsanchez', bio: '', idea: '', marco: '' }, 90, 'auth7', false, 'org1', [Permiso.PUBLICAR_EN_SALA, Permiso.TOMAR_DE_PIZARRA], new Date(Date.now() - 25 * 60000)),
    new Usuario('8', 'laura.torres@example.com', Rol.MIEMBRO, { nombre: 'Laura Torres', apellido: '', avatar: '', nivel: 5, correo: 'laura.torres@example.com', username: 'ltorres', bio: '', idea: '', marco: '' }, 87, 'auth8', false, 'org1', [Permiso.VER_CAPTURAS_USUARIO], new Date(Date.now() - 2 * 24 * 60 * 60000)),
    new Usuario('9', 'pablo.ramirez@example.com', Rol.MIEMBRO, { nombre: 'Pablo Ramírez', apellido: '', avatar: '', nivel: 2, correo: 'pablo.ramirez@example.com', username: 'pramirez', bio: '', idea: '', marco: '' }, 79, 'auth9', false, 'org1', [Permiso.VER_CAPTURAS_USUARIO], new Date(Date.now() - 50 * 60000)),
    new Usuario('10', 'valeria.castro@example.com', Rol.ADMIN, { nombre: 'Valeria Castro', apellido: '', avatar: '', nivel: 7, correo: 'valeria.castro@example.com', username: 'vcastro', bio: '', idea: '', marco: '' }, 96, 'auth10', true, 'org1', [Permiso.CREAR_SALA, Permiso.ELIMINAR_USUARIO, Permiso.ELIMINAR_PROYECTO], new Date(Date.now() - 4 * 60000)),
    new Usuario('11', 'javier.morales@example.com', Rol.MIEMBRO, { nombre: 'Javier Morales', apellido: '', avatar: '', nivel: 3, correo: 'javier.morales@example.com', username: 'jmorales', bio: '', idea: '', marco: '' }, 82, 'auth11', false, 'org1', [Permiso.VER_CAPTURAS_USUARIO], new Date(Date.now() - 6 * 60 * 60000)),
    new Usuario('12', 'camila.ruiz@example.com', Rol.MIEMBRO, { nombre: 'Camila Ruiz', apellido: '', avatar: '', nivel: 4, correo: 'camila.ruiz@example.com', username: 'cruiz', bio: '', idea: '', marco: '' }, 91, 'auth12', false, 'org1', [Permiso.PUBLICAR_EN_SALA, Permiso.TOMAR_DE_PIZARRA], new Date(Date.now() - 30 * 60000)),
